...
public class TreeKDEBench {
    ...
    // PARAMETERS
    // *******
    public static final String configPath = "src/test/resources/conf/tree_kde_bench_energy.yaml";
    ...
    public TreeKDEBench loadParams(String path) throws IOException {
        Yaml yaml = new Yaml();
    ...
    public void run() throws Exception {
        ...
        TreeKDETransform t = new TreeKDETransform(mbConf, treeConf);
